...
export default class DateOption extends Component {
    ...
    render() {
        ...
        return (
            <div className="task-start-date date-option-container">
                ...
                <div className="calendar-button-container">
                    <button
                        className="task-start-date calendar-button"
                        onClick={this.updateDate}
                        value={todayFullString}
                        datename="Today"
                        datedetail={todayDateDetail}
                    >
                        Today<div className="task-start-date date-detail">{todayDateDetail}</div>
                    </button>
                    <button
                        className="task-start-date calendar-button"
                        onClick={this.updateDate}
                    ...
                    >
                        Tomorrow<div className="task-start-date date-detail">{tomorrowDateDetail}</div>
                    </button>
                    <button
                        className="task-start-date calendar-button"
                        onClick={this.updateDate}
                    ...
                    >
                        {dayTwoName}
                        <div className="task-start-date date-detail">{dayTwoDateDetail}</div>
                    </button>
                    <button
                        className="task-start-date calendar-button"
                        onClick={this.updateDate}
                    ...
                    >
                        {dayThreeName}
                        <div className="task-start-date date-detail">{dayThreeDateDetail}</div>
                    </button>
                    <button
                        className="task-start-date calendar-button"
                        onClick={this.updateDate}
                    ...
                    >
                        {dayFourName}
                        <div className="task-start-date date-detail">{dayFourDateDetail}</div>
                    </button>
                </div>
                <div className="select-date-button-container">
                    <div className="select-date">
                        <button className="task-start-date feature-buttons" onClick={this.toggleDatePicker}>
                            Select Date
            </button>
                        <div className="date-picker">
                            {this.state.showDatePicker ? (
                                <input className="task-start-date" type="date" onChange={this.handleChange} />
                            ) : (
                                    <div />
                                )}
                        </div>
                    </div>
                    <button className="task-start-date feature-buttons" onClick={this.handleSubmit}>
                        Submit
          </button>
                </div>
            </div>
